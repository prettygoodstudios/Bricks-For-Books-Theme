...
function donation_page_header_widget_init(){
	register_sidebar(
		array(
			'name'          => esc_html__( 'Header image for donation page', 'Bricks For Books' ),
			'id'            => 'donation-header-image',
			'description'   => esc_html__( 'Header image for donation page.', 'Bricks For Books' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '',
			'after_title'   => '',
...
class Team_Member extends WP_Widget {
    ...
    public $args = array(
        'before_title'  => '<h4 class="team-member__title">',
        'after_title'   => '</h4>',
        'before_widget' => '<div class="team-member">',
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html__( 'Name:', 'text_domain' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'Text' ) ); ?>"><?php echo esc_html__( 'Image:', 'text_domain' ); ?></label>
            <input id="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'text' ) ); ?>" type="text" />
        </p>
        <?php
